...
const AddSchool = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await apiHelpers.post('/schools', payload);
      ...
      setError(error.message || 'Failed to create school. Please try again.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <Layout.Content>
        {success && (
          <Alert type="success" className="mb-6">
            School created successfully! Redirecting to schools list...
          </Alert>
        )}
